...
public class LookingGlassConfiguredFeatures {
    ...
    public static void init() {
        ...
        RED_SEAGRASS = register("red_seagrass", UNDERWATER_PLANT_FEATURE.configure(new BiFeatureConfig(LookingGlassBlocks.RED_SEAGRASS.getDefaultState(), LookingGlassBlocks.TALL_RED_SEAGRASS.getDefaultState(), 0.3F, UniformIntDistribution.of(0))).repeat(24).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(4))));
