...
public class LookingGlassConfiguredFeatures extends ConfiguredFeatures {
    ...
    public static void init() {
        ...
        SALT_DELTA = register("salt_delta", Feature.DELTA_FEATURE.configure(new DeltaFeatureConfig(Blocks.WATER.getDefaultState(), LookingGlassBlocks.SALT_CLUSTER_BLOCK.getDefaultState(), UniformIntProvider.create(2, 7), UniformIntProvider.create(0, 2))).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(40))));
        ...
        WHITEDUST_DISCS = register("whitedust_discs", Feature.DISK.configure(new DiskFeatureConfig(LookingGlassBlocks.WHITEDUST.getDefaultState(), UniformIntProvider.create(2, 6), 1, ImmutableList.of(LookingGlassBlocks.WHITESTONE_BLOCK.getDefaultState(), Blocks.STONE.getDefaultState()))).decorate(ConfiguredFeatures.Decorators.SQUARE_TOP_SOLID_HEIGHTMAP));
        SALT_DISCS = register("salt_discs", Feature.DISK.configure(new DiskFeatureConfig(LookingGlassBlocks.SALT_CLUSTER_BLOCK.getDefaultState(), UniformIntProvider.create(1, 3), 2, ImmutableList.of(LookingGlassBlocks.WHITESTONE_BLOCK.getDefaultState(), Blocks.STONE.getDefaultState()))).decorate(ConfiguredFeatures.Decorators.SQUARE_TOP_SOLID_HEIGHTMAP));

        CRACKED_CRUST = register("cracked_crust", UNDERWATER_CRUST_FEATURE.configure(new BiFeatureConfig(LookingGlassBlocks.WHITESTONE_BLOCK.getDefaultState(), LookingGlassBlocks.WHITESTONE_CRACKED.getDefaultState(), 0.225F, UniformIntProvider.create(3, 8))).applyChance(3).decorate(ConfiguredFeatures.Decorators.SQUARE_TOP_SOLID_HEIGHTMAP));
        VOLCANIC_CRUST = register("volcanic_crust", UNDERWATER_CRUST_FEATURE.configure(new BiFeatureConfig(Blocks.BASALT.getDefaultState(), LookingGlassBlocks.HOT_BASALT.getDefaultState(), 0.195F, UniformIntProvider.create(2, 6))).applyChance(2).decorate(ConfiguredFeatures.Decorators.SQUARE_TOP_SOLID_HEIGHTMAP));
