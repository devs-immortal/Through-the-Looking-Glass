...
public class UnstableAltarRenderer extends BlockEntityRenderer<UnstableAltarEntity> {
    ...
    @Override
    public void render(UnstableAltarEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
    ...
    @Override
    public boolean rendersOutsideBoundingBox(UnstableAltarEntity unstableAltarEntity) {
        return true;
    }
}
