...
public class InductionRecipeCategory extends AbstractLookingGlassRecipeCategory<InductionRecipe> {
    ...
    public InductionRecipeCategory() {
        super(LookingGlassRecipes.INDUCTION_RECIPE, EntryStacks.of(LookingGlassBlocks.BLOCK_INDUCTOR_BLOCK));
    }

    @Override
    public @NotNull List<Widget> setupDisplay(LookingGlassREIisplay<InductionRecipe> recipeDisplay, Rectangle bounds) {
        ...
        widgets.add(Widgets.createSlot(new Point(start.x + 32, start.y + 9)).entries(Collections.singleton(EntryStacks.of(LookingGlassBlocks.BLOCK_INDUCTOR_BLOCK))).disableBackground());
