...
public class LookingGlassCompat {
    ...
    public static void init() {
        if(LookingGlassCommon.DEV_ENV && LookingGlassCommon.REGEN_RECIPES) {
            for (String oreGroup : GRINDING) {
                ...
                genGrinderRecipe(name + "_ore_to_dusts", new String[]{ "c:" + components[0] + "_ores", "c:" + components[0] + "_dusts", "2", "c:" + components[1] + "_dusts", "1", components[2] });
