...
public class LookingGlassItems {
    ...
    public static final Item UNSTABLE_ENCHANTER_BLOCK = registerItem("unstable_altar", new UnstableEnchanterBlockItem(LookingGlassBlocks.UNSTABLE_ALTAR_BLOCK, new FabricItemSettings().group(LOOKINGGLASS_BLOCKS)));
